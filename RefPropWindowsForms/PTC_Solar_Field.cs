...
namespace RefPropWindowsForms
{
    public partial class PTC_Solar_Field : Form
    {
        ...
        public void Calculate_PHX()
        {
            ...
            // RC_Design_WithReHeating new configuration: Brayton_cycle_type_variable = 23
            else if (this.Brayton_cycle_type_variable == 23)
            {
            ...
            // RC_without_ReHeating_new_proposed_configuration: Brayton_cycle_type_variable = 21
            else if (this.Brayton_cycle_type_variable == 21)
            {
  
            }

            // RCMCI_without_ReHeating_new_proposed_configuration: Brayton_cycle_type_variable = 22
            else if (this.Brayton_cycle_type_variable == 22)
            {
            ...
            else if (this.Brayton_cycle_type_variable == 18)
            {
            ...
            // PCRC_Optimization_WithReHeating: Brayton_cycle_type_variable = 26
            else if (this.Brayton_cycle_type_variable == 26)
            {
            ...
            // RCMCI_Design_WithReHeating: Brayton_cycle_type_variable = 24
            ...
            // RCMCI_Design_with_Two_Intercooling_WithoutReHeating: Brayton_cycle_type_variable = 28
            else if (this.Brayton_cycle_type_variable == 28)
            {
        ...
        public void button3_Click(object sender, EventArgs e)
        {
            ...
            // RC_Design_WithoutReHeating new configuration: Brayton_cycle_type_variable = 21
            else if (this.Brayton_cycle_type_variable == 21)
            {
                
            }

            // RCMCI_Design_WithoutReHeating_new configuration: Brayton_cycle_type_variable = 22
            else if (this.Brayton_cycle_type_variable == 22)
            {
            ...
            // PCRC_Optimization_WithReHeating new configuration: Brayton_cycle_type_variable = 26
            else if (this.Brayton_cycle_type_variable == 26)
            {
        ...
        public void button2_Click(object sender, EventArgs e)
        {
            ...
            //RC_Design_withReHeating new configuration
            else if (this.Brayton_cycle_type_variable == 23)
            {
            ...
            //RC_Design_withoutReHeating new configuration
            else if (this.Brayton_cycle_type_variable ==21)
            {

            }

            //RCMCI_Design_withoutReHeating new configuration
            else if (this.Brayton_cycle_type_variable == 22)
            {
            ...
            //PCRC_Design_withThreeReHeating
            else if (this.Brayton_cycle_type_variable == 18)
            {
            ...
            //PCRC_Optimization_withReHeating new configuration
            else if (this.Brayton_cycle_type_variable == 26)
            {
            ...
            //PCRC_Design_with_Two_Intercooling_without_ReHeating
            else if (this.Brayton_cycle_type_variable == 27)
            {
            ...
            //RCMCI_Design_with_Two_Intercooling_withoutReHeating
            else if (this.Brayton_cycle_type_variable == 28)
            {
